...
El [corte inicial de evaluación Gemini del 25-09-2026](GEMINI-EDITORIAL-EVALUATION-2026-09-25.md) registra casos, hashes, gates de producto y brechas aún abiertas. Las semanas ficticias de Cactus se reportan aparte de las semanas históricas completas.
...
1. Partí del [inventario ordenado de cuentas, modelos y cuotas](PROVIDER-STATUS.md#cuentas-de-maatwork-ordenadas-por-evidencia-editorial). Verificá una sola cuenta MaatWork por proveedor, sin tarjeta ni facturación, y registrá tarifa cero o cupo Free con corte duro, condiciones de API, cuotas exactas, fecha, modelo y cargas autorizadas en el catálogo local. La clave de Final Router es sólo para evaluación: su guardrail falló una prueba negativa y no debe recibir borradores editoriales ni figurar en el catálogo verificado. Ningún crédito de prueba cuenta como capacidad estable. Guardá claves sólo en el almacén del proyecto.
