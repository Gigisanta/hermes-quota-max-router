...
| Final Router Free | La [página oficial](https://finalrouter.com/free-models) anuncia 25 solicitudes diarias renovables, sin tarjeta, para `openai/gpt-5-mini` y `deepseek/deepseek-v4-flash`; la [tabla de precios](https://finalrouter.com/pricing) indica 20 RPM y 402 al agotar el cupo. Sus [términos](https://finalrouter.com/terms) prohíben revender acceso bruto y construir un catálogo competidor mediante scraping. Nuestro uso editorial interno podría ser admisible, pero el operador agrupa proveedores ascendentes y su página describe la cuota como prueba del producto. | Alta aún pendiente de consentimiento, clave, comprobación de cuota/precio/uso y calidad. No se cuenta como operador independiente ni reserva productiva hasta verificar también el proveedor efectivo; nunca usar `auto` ni un modelo de precio positivo. |
